<template>
    <div class="clock" v-if="hourtime != ''">
        <div class="clock__hours" :style="styleObject">
            <span class="clock__hourtime" v-text="hourtime"></span>
            <span v-text="hours"></span>
        </div>
        <div class="clock__minutes" v-bind:style="styleObject" v-text="minutes"></div>
        <div class="clock__seconds" v-bind:style="styleObject" v-text="seconds"></div>
    </div>
</template>
